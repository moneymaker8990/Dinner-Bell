-- Ensure crypto helpers are available and avoid hard dependency on gen_random_bytes.
...
BEGIN
  ...
  -- Prefer caller token; otherwise use UUID text fallback to avoid gen_random_bytes dependency.
